...
{
	static inline consteval int32 GetStructSize() { return sizeof(FArchitectMaterialOverride); }
	static inline consteval int16 GetStructAlignment() { return alignof(FArchitectMaterialOverride); }
#if WITH_METADATA
...
// ********** Begin ScriptStruct FArchitectMaterialOverride constinit property declarations ********
...
// ********** End ScriptStruct FArchitectMaterialOverride constinit property declarations **********
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FArchitectMaterialOverride;
class UScriptStruct* FArchitectMaterialOverride::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FArchitectMaterialOverride.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FArchitectMaterialOverride.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FArchitectMaterialOverride, (UObject*)Z_Construct_UPackage__Script_ArchitectCore(), TEXT("ArchitectMaterialOverride"));
	}
	return Z_Registration_Info_UScriptStruct_FArchitectMaterialOverride.OuterSingleton;
	}

// ********** Begin ScriptStruct FArchitectMaterialOverride Property Definitions *******************
...
// ********** End ScriptStruct FArchitectMaterialOverride Property Definitions *********************
...
{
	if (!Z_Registration_Info_UScriptStruct_FArchitectMaterialOverride.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FArchitectMaterialOverride.InnerSingleton, Z_Construct_UScriptStruct_FArchitectMaterialOverride_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FArchitectMaterialOverride.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FArchitectMaterialOptions); }
	static inline consteval int16 GetStructAlignment() { return alignof(FArchitectMaterialOptions); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/PCArchitectBase.h" },
...
// ********** Begin ScriptStruct FArchitectMaterialOptions constinit property declarations *********
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FArchitectMaterialOptions constinit property declarations ***********
	static void* NewStructOps()
	{
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FArchitectMaterialOptions;
class UScriptStruct* FArchitectMaterialOptions::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FArchitectMaterialOptions.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FArchitectMaterialOptions.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FArchitectMaterialOptions, (UObject*)Z_Construct_UPackage__Script_ArchitectCore(), TEXT("ArchitectMaterialOptions"));
	}
	return Z_Registration_Info_UScriptStruct_FArchitectMaterialOptions.OuterSingleton;
	}

// ********** Begin ScriptStruct FArchitectMaterialOptions Property Definitions ********************
...
// ********** End ScriptStruct FArchitectMaterialOptions Property Definitions **********************
...
{
	if (!Z_Registration_Info_UScriptStruct_FArchitectMaterialOptions.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FArchitectMaterialOptions.InnerSingleton, Z_Construct_UScriptStruct_FArchitectMaterialOptions_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FArchitectMaterialOptions.InnerSingleton);
}
...
{
	static inline consteval int32 GetStructSize() { return sizeof(FArchitectOverrides); }
	static inline consteval int16 GetStructAlignment() { return alignof(FArchitectOverrides); }
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "ModuleRelativePath", "Public/PCArchitectBase.h" },
...
// ********** Begin ScriptStruct FArchitectOverrides constinit property declarations ***************
	...
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
// ********** End ScriptStruct FArchitectOverrides constinit property declarations *****************
	static void* NewStructOps()
	{
...
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_FArchitectOverrides;
class UScriptStruct* FArchitectOverrides::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_FArchitectOverrides.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_FArchitectOverrides.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FArchitectOverrides, (UObject*)Z_Construct_UPackage__Script_ArchitectCore(), TEXT("ArchitectOverrides"));
	}
	return Z_Registration_Info_UScriptStruct_FArchitectOverrides.OuterSingleton;
	}

// ********** Begin ScriptStruct FArchitectOverrides Property Definitions **************************
...
// ********** End ScriptStruct FArchitectOverrides Property Definitions ****************************
...
{
	if (!Z_Registration_Info_UScriptStruct_FArchitectOverrides.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_FArchitectOverrides.InnerSingleton, Z_Construct_UScriptStruct_FArchitectOverrides_Statics::StructParams);
	}
	return CastChecked<UScriptStruct>(Z_Registration_Info_UScriptStruct_FArchitectOverrides.InnerSingleton);
}
// ********** End ScriptStruct FArchitectOverrides *************************************************

// ********** Begin Class APCArchitectBase *********************************************************
FClassRegistrationInfo Z_Registration_Info_UClass_APCArchitectBase;
UClass* APCArchitectBase::GetPrivateStaticClass()
{
	using TClass = APCArchitectBase;
	if (!Z_Registration_Info_UClass_APCArchitectBase.InnerSingleton)
	{
		GetPrivateStaticClassBody(
			TClass::StaticPackage(),
			TEXT("PCArchitectBase"),
			Z_Registration_Info_UClass_APCArchitectBase.InnerSingleton,
			StaticRegisterNativesAPCArchitectBase,
			sizeof(TClass),
			alignof(TClass),
	...
	return Z_Registration_Info_UClass_APCArchitectBase.InnerSingleton;
}
UClass* Z_Construct_UClass_APCArchitectBase_NoRegister()
{
	return APCArchitectBase::GetPrivateStaticClass();
}
...
// ********** Begin Class APCArchitectBase constinit property declarations *************************
// ********** End Class APCArchitectBase constinit property declarations ***************************
...
DEFINE_VTABLE_PTR_HELPER_CTOR_NS(, APCArchitectBase);
APCArchitectBase::~APCArchitectBase() {}
// ********** End Class APCArchitectBase ***********************************************************

// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_UnrealEngine5_Projects_PCGArchitect_pACKAGES_5_7_v2_ArchitectCore_HostProject_Plugins_ArchitectCore_Source_ArchitectCore_Public_PCArchitectBase_h__Script_ArchitectCore_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EArchitectOverideModes_StaticEnum, TEXT("EArchitectOverideModes"), &Z_Registration_Info_UEnum_EArchitectOverideModes, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1040904828U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FArchitectMaterialOverride::StaticStruct, Z_Construct_UScriptStruct_FArchitectMaterialOverride_Statics::NewStructOps, TEXT("ArchitectMaterialOverride"),&Z_Registration_Info_UScriptStruct_FArchitectMaterialOverride, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FArchitectMaterialOverride), 2853187936U) },
		{ FArchitectMaterialOptions::StaticStruct, Z_Construct_UScriptStruct_FArchitectMaterialOptions_Statics::NewStructOps, TEXT("ArchitectMaterialOptions"),&Z_Registration_Info_UScriptStruct_FArchitectMaterialOptions, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FArchitectMaterialOptions), 1853728793U) },
		{ FArchitectOverrides::StaticStruct, Z_Construct_UScriptStruct_FArchitectOverrides_Statics::NewStructOps, TEXT("ArchitectOverrides"),&Z_Registration_Info_UScriptStruct_FArchitectOverrides, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FArchitectOverrides), 1304736050U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_APCArchitectBase, APCArchitectBase::StaticClass, TEXT("APCArchitectBase"), &Z_Registration_Info_UClass_APCArchitectBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(APCArchitectBase), 654005131U) },
	};
}; // Z_CompiledInDeferFile_FID_UnrealEngine5_Projects_PCGArchitect_pACKAGES_5_7_v2_ArchitectCore_HostProject_Plugins_ArchitectCore_Source_ArchitectCore_Public_PCArchitectBase_h__Script_ArchitectCore_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealEngine5_Projects_PCGArchitect_pACKAGES_5_7_v2_ArchitectCore_HostProject_Plugins_ArchitectCore_Source_ArchitectCore_Public_PCArchitectBase_h__Script_ArchitectCore_3119411237{
	TEXT("/Script/ArchitectCore"),
	Z_CompiledInDeferFile_FID_UnrealEngine5_Projects_PCGArchitect_pACKAGES_5_7_v2_ArchitectCore_HostProject_Plugins_ArchitectCore_Source_ArchitectCore_Public_PCArchitectBase_h__Script_ArchitectCore_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealEngine5_Projects_PCGArchitect_pACKAGES_5_7_v2_ArchitectCore_HostProject_Plugins_ArchitectCore_Source_ArchitectCore_Public_PCArchitectBase_h__Script_ArchitectCore_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_UnrealEngine5_Projects_PCGArchitect_pACKAGES_5_7_v2_ArchitectCore_HostProject_Plugins_ArchitectCore_Source_ArchitectCore_Public_PCArchitectBase_h__Script_ArchitectCore_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealEngine5_Projects_PCGArchitect_pACKAGES_5_7_v2_ArchitectCore_HostProject_Plugins_ArchitectCore_Source_ArchitectCore_Public_PCArchitectBase_h__Script_ArchitectCore_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_UnrealEngine5_Projects_PCGArchitect_pACKAGES_5_7_v2_ArchitectCore_HostProject_Plugins_ArchitectCore_Source_ArchitectCore_Public_PCArchitectBase_h__Script_ArchitectCore_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealEngine5_Projects_PCGArchitect_pACKAGES_5_7_v2_ArchitectCore_HostProject_Plugins_ArchitectCore_Source_ArchitectCore_Public_PCArchitectBase_h__Script_ArchitectCore_Statics::EnumInfo),
};
// ********** End Registration *********************************************************************
